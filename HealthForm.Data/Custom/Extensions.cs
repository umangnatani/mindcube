...
namespace HealthForm.Data
{
    ...
    {
        //public static void SaveWithOptions(this IService<ListColumnOption> service, IEnumerable<ListColumnOption> oldChildren, IEnumerable<ListColumnOption> newChildren)
        //{
